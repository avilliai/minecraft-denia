...
public class GirlfriendConfig {
    ...
    public static class Llm {
        ...
        public String systemPrompt = String.join("\n",
            ...
            "- 复合材料或工具优先用 craft_item 自主合成，需烧炼的矿物/熟食先放入熔炉 interact_furnace；",
            "- 伤重或饥饿时用 use_item 进食/喝药/自救，遭遇群怪危急时用 emergency_shelter 就地造庇护所；",
            "- 随手放置火把 place_block 或原地起跳垫方块 build_pillar 登上高台或脱困；",
            "- 整理搜刮用 interact_chest：存放杂物 deposit 或寻找所需工具 withdraw；",
            "- 闲暇时用 evaluate_inventory 评估背包品质，吐槽破烂、偏爱热熔与亮晶晶的宝石材料。",
    ...
    public static class Prompts {
        ...
        public List<String> underwaterOrCave = List.of(
            "泡在水里衣服都要湿透啦……你小声嘀咕着想快点游上岸晒干。",
            "水底下水压好沉呀，你扯了扯他的衣角，问漂泊者什么时候浮上去透气。",
            "咕嘟咕嘟……你鼓着腮帮子憋气，眼神催他快点游回水面上。"
        );
